...
contract HackerX is ERC721Enumerable, Ownable {
...
function getAllNFTs() public view returns (SaleStuct[] memory) {
    return minted;
}

function getAnNFTs(uint256 tokenId) public view returns(SaleStuct memory){
